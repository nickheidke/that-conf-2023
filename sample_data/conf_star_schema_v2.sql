INSERT INTO conf_star_schema_v2.dim_speaker (speaker_id, speaker_name)
VALUES (1, 'John Smith');
...
DELETE FROM conf_star_schema_v2.dim_speaker_social;

INSERT INTO conf_star_schema_v2.dim_speaker_social (speaker_social_id, social_media_type, social_media_link, speaker_id)
...
INSERT INTO conf_star_schema_v2.dim_session (session_id, session_name, session_date, session_timeslot)
...
INSERT INTO conf_star_schema_v2.dim_participant (participant_id, participant_first_name, participant_last_name, participant_email)
...
INSERT INTO conf_star_schema_v2.fact_session_attendance (session_attendance_id, speaker_id, session_id, participant_id)
VALUES (1, 1, 5, 3);
