create schema conf_star_schema_v1;

DROP TABLE IF EXISTS conf_star_schema_v1.dim_speaker;

create table conf_star_schema_v1.dim_speaker
(
...
DROP TABLE IF EXISTS conf_star_schema_v1.dim_speaker_social;

create table conf_star_schema_v1.dim_speaker_social
(
...
DROP TABLE IF EXISTS conf_star_schema_v1.dim_participant;

create table conf_star_schema_v1.dim_participant
(
...
create table conf_star_schema_v1.dim_session
(
...
create table conf_star_schema_v1.fact_session_attendance
(
